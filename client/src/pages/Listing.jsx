...
//  for photo sliding we are using swiper
const Listing = () => {
...
{listing && !loading && !error && <>
  ...
  <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
    ...
    <p className='flex items-center mt-6 gp-2 text-slate-600 text-sm'>
...
// we can add mailing feature using Link tag form react router dom
// need to see navigator