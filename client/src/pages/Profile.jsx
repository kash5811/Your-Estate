  ...
  return (
   <div className="p-3 max-w-lg mx-auto">
    ...
    <p className="text-sm self-center">
      {fileUploadError ? (
        <span className="text-red-700"> Error Image uplod</span>
      ): filePerc > 0 && filePerc < 100 ? (
        <span className="text-slte-700">{`Uploading ${filePerc}%`}</span>
            ) : filePerc === 100 ? (
   ...
   Update
      ...
      <Link to={"/create-listing"} className="bg-green-700 text-white p-3 rounded-lg uppercase text-center
      hover:opacity-95 
      " >
        Create Listing
      </Link>
