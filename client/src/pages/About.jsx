...
const About = () => {
  return (
    ...
    <h1 className='text-3xl font-bold mb-4 text-slate-800'>About Your Estate</h1>
    <p className='mb-4 text-slate-700'>Your Estate is a leading real estate agency that specializes in helping clients buy, sell, and rent properties in the most desirable neighborhoods. Our team of experienced agents is dedicated to providing exceptional service and making the buying and selling process as smooth as possible.</p>
